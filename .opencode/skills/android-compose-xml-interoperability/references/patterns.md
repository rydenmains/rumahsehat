# Android Compose XML Interoperability Patterns

## Selection Notes
- Category: `ui`
- Best fit when the request matches the trigger language in `SKILL.md` and the implementation focus is `Bridge Compose and the View system safely during incremental migrations, interoperability screens, and shared theming.`
